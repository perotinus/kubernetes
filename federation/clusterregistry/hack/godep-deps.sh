...
mkdir -p ${goPath}/src/k8s.io/clusterregistry
cp -R . ${goPath}/src/k8s.io/clusterregistry

pushd ${goPath}/src/k8s.io/clusterregistry
rm -rf vendor || true
...
mv ${goPath}/src/k8s.io/clusterregistry/vendor .
mv ${goPath}/src/k8s.io/clusterregistry/Godeps .
git add vendor
git add Godeps
